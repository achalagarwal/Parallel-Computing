...
public final class ParBoruvka extends AbstractBoruvka<ParBoruvka.ParComponent> {
    ...
    public void computeBoruvka(final Queue<ParComponent> nodesLoaded,
        ...
        final ParComponent[] ans = new ParComponent[1];


        ParComponent node1;

        while ((node1 = nodesLoaded.poll()) != null) {
            ...
            final Edge<ParComponent> edge1 = node1.getMinEdge();
            ...
            final ParComponent node2 = edge1.getOther(node1);

            if (!node2.rl.tryLock()) {
                node1.rl.unlock();
                nodesLoaded.add(node1);
                continue;
            }
            ...
            node1.merge(node2, edge1.weight());
